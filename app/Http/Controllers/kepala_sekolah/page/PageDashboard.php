...
class PageDashboard extends Controller
{
    public function index()
    {
        if (isset($_COOKIE["userid"])) {
            ...
            return view("kepala-sekolah.home", compact('datalogin', 'data'));
    ...
    public function tahun_akademik()
    {
        ...
        if (isset($_COOKIE["userid"])) {
            ...
            return view("kepala-sekolah.tahun_ajaran", compact("datalogin", 'data'));
        } else {
            return redirect("admin/login");
        }
    }
    ...
    public function ruangan()
    {
        ...
        if (isset($_COOKIE["userid"])) {
            ...
            return view("kepala-sekolah.ruangan", compact("datalogin", 'data'));
        } else {
            return redirect("admin/login");
        }
    }
    ...
    public function mapel()
    {
        ...
        if (isset($_COOKIE["userid"])) {
            ...
            return view("kepala-sekolah.mapel", compact("datalogin", 'data'));
        } else {
            return redirect("admin/login");
        }
    }
    ...
    public function jadwal()
    {
        ...
        if (isset($_COOKIE["userid"])) {
            ...
            return view("kepala-sekolah.jadwal", compact("datalogin", 'data'));
        } else {
            return redirect("admin/login");
        }
    }
    ...
    public function siswa()
    {
        ...
        if (isset($_COOKIE["userid"])) {
            ...
            return view("kepala-sekolah.siswa", compact("datalogin", 'data'));
        } else {
            return redirect("admin/login");
        }
    }
    ...
    public function raport()
    {
        ...
        if (isset($_COOKIE["userid"])) {
            ...
            return view("kepala-sekolah.raport", compact("datalogin", 'data'));
        } else {
            return redirect("admin/login");
        }
    }
