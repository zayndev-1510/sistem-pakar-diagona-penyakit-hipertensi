                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li>
                                <a href="{{ url('guru/page/dashboard') }}" aria-expanded="true"><i
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    <li>
                                        <a href="{{ url('guru/page/tahun-akademik') }}">
                                            <i class="ti-calendar"></i>
                                            <span>Tahun Akademik</span></a>
                                    </li>
                                    <li>
                                        <a href="{{ url('guru/page/ruangan') }}">
                                            <i class="ti-user"></i>
                                            <span>Ruangan</span></a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    <li><a href="{{ url('guru/page/matpel') }}">
                                            <i class="ti-book" aria-hidden="true"></i>
                                            <span>Mata Pelajaran</span></a>
                                    </li>
                                    <li>
                                        <a href="{{ url('guru/page/jadwal') }}" aria-expanded="true">
                                            <i class="ti-calendar"></i><span> Jadwal Matpel </span></a>
                                    </li>
                                    <li><a href="{{ url('guru/page/siswa') }}">
                                            <i class="ti-user" aria-hidden="true"></i>
                                            <span>Siswa</span></a>
                                    </li>
                                     <li><a href="{{ url('guru/page/nilai') }}">
                                            <i class="ti-book" aria-hidden="true"></i>
