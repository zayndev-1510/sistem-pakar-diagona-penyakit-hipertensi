        ...
        <div class="sidebar-menu" style="background-color: #483D8B;color:white;">
            <div class="sidebar-header" style="background-color: #483D8B;color:white;">
                <div class="logo">
                    ...
                    <input type="hidden" value="<?php echo $datalogin[0]->id; ?>" id="id_pengguna_temp">
                </div>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li>
                                <a href="{{ url('kepala-sekolah/page/dashboard') }}" aria-expanded="true"><i
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    <li>
                                        <a href="{{ url('kepala-sekolah/page/tahun-akademik') }}">
                                            <i class="ti-calendar"></i>
                                            <span>Tahun Akademik</span></a>
                                    </li>
                                    <li>
                                        <a href="{{ url('kepala-sekolah/page/ruangan') }}">
                                            <i class="ti-user"></i>
                                            <span>Ruangan</span></a>
                                    </li>
                                </ul>
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    <li>
                                        <a href="{{ url('kepala-sekolah/page/jadwal') }}" aria-expanded="true">
                                            <i class="ti-calendar"></i><span> Jadwal Matpel </span></a>
                                    </li>
                                    <li><a href="{{ url('kepala-sekolah/page/siswa') }}">
                                            <i class="ti-user" aria-hidden="true"></i>
                                            <span>Laporan Siswa</span></a>
                                    </li>

                                    <li>
                                        <a href="{{ url('kepala-sekolah/page/raport') }}">
                                            <i class="ti-user" aria-hidden="true"></i>
                                            <span>Laporan Raport Siswa</span></a>
                                    </li>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            <img class="avatar user-thumb" src="{{ asset('guru/' . $datalogin[0]->foto) }}"
                                alt="avatar">
