                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li>
                                <a href="{{ url('orangtua/page/dashboard') }}" aria-expanded="true"><i
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    <li>
                                        <a href="{{ url('orangtua/page/tahun-akademik') }}">
                                            <i class="ti-calendar"></i>
                                            <span>Tahun Akademik</span></a>
                                    </li>
                                    <li>
                                        <a href="{{ url('orangtua/page/ruangan') }}">
                                            <i class="ti-user"></i>
                                            <span>Ruangan</span></a>
                                    </li>
                                </ul>
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    <li>
                                        <a href="{{ url('orangtua/page/jadwal') }}" aria-expanded="true">
                                            <i class="ti-calendar"></i><span> Jadwal Matpel </span></a>
                                    </li>
                                    <li><a href="{{ url('orangtua/page/siswa') }}">
                                            <i class="ti-user" aria-hidden="true"></i>
                                            <span>Siswa</span></a>
                                    </li>
                                    <li><a href="{{ url('orangtua/page/raport') }}">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            <img class="avatar user-thumb" src="{{ asset('orangtua/' . $datalogin[0]->foto) }}"
                                alt="avatar">
                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown">
                                {{ $datalogin[0]->nama_ayah }}
