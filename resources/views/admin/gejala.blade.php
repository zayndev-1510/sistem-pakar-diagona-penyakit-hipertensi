                    ...
                    <div class="card-body" id="tabel-toko">
                        <div class="row" style="margin-bottom: 10px;">
                            ...
                            <div class="col-2">
                                ...
                                ng-click="tambahData()"> <i class="ti-plus"></i> Menambahkan Gejala</p>
                            </div>
                        </div>
...
@section('javascript')
    ...
    <script src="{{ asset('assets/js/admin/gejala/app.js') }}"></script>
    <script src="{{ asset('assets/js/admin/gejala/service.js') }}"></script>
@endsection
